...
export const InputChat = () => {
      ...
      return (
            <>
                  <div className="fixed h-[56px] bottom-0 md:w-[calc(100vw-360px)] w-[calc(100vw-60px)] flex flex-col justify-center items-center bg-white dark:bg-[#171717] flex-grow">
                        <div className="relative w-full flex justify-between px-[0.3145rem] my-2">
                              ...
                              <input
                                    ...
                                    className="rounded-full  w-full m-auto h-[40px] pl-4 text-lg ring-1 dark:text-white ring-slate-300 dark:ring-slate-600 outline-none focus:border   dark:bg-slate-600 "
                              />
                              <ion-icon
                                    name="happy-outline"
