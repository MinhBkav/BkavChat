...
import { setOpenInfoChat } from '../../../feature/dataSlice'
  ...
  return (
    <>
      <div className=" h-[60px] w-full  bg-white dark:bg-[#171717]  ">
        <div className="relative flex justify-between  py-[6.5px]">
          ...
          <div className = "flex items-center">
            <button onClick = {()=>{dispatch(setOpenInfoChat(true))}} ><ion-icon name="information-circle-outline" className = "w-6 h-6 font-[500] pr-3"></ion-icon></button>
          </div>
        </div>
      </div>
    </>
